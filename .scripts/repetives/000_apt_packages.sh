sudo apt install -y cowsay python3 git \
    ...
    autoconf  libtool waybar network-manager swaylock zstd git-lfs  grim slurp wl-clipboard \
    libwxgtk3.2-dev  build-essential autoconf libncurses-dev libssl-dev >> "$LOG_FILE"
